...
# キャラクター情報のクラス
class Characlass:
    def __init__(self, filename: str, hp: int,enemy: bool):
...
# 1:自機弾
charas.append(Characlass("mushroomRed.png",1,False))
# 2:自機
charas.append(Characlass("alien.png", 2, False))
# 3:敵弾
charas.append(Characlass("fireball.png", 1,True))
# 4:敵1
charas.append(Characlass("flyFly1.png", 1, True))
# 5:敵2
charas.append(Characlass("fishSwim1.png", 2, True))
# 6:ボス
charas.append(Characlass("snailwalk1.png",15,True))
# 7:隕石
pipe_bottom = Actor('rockMossAlt', anchor=('left', 'top'))
